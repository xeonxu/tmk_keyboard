...
#define KEYMAP_HHKB( \
    ...
    KE0,KE3,KE2,        K2C,                KE6,K65,    KE4,\
            ...
            NO, NO, NO, NO, NO, NO, NO, NO, NO, NO, NO, NO,                                               \
    K29,    K3A,K3B,K3C,K3D,K3E,K3F,K40,K41,K42,K43,K44,K45,      K46,K47,K48,  NO, NO, NO, NO,  NO,      \
    K29,K1E,K1F,K20,K21,K22,K23,K24,K25,K26,K27,K2D,K2E,NO, K2A,  K49,K4A,K4B,  K53,K54,K55,K56, NO, NO,  \
    K2B,K14,K1A,K08,K15,K17,K1C,K18,K0C,K12,K13,K2F,K30,    K31,  K4C,K4D,K4E,  K5F,K60,K61,K57, NO, NO,  \
    K39,K04,K16,K07,K09,K0A,K0B,K0D,K0E,K0F,K33,K34,    NO, K28,                K5C,K5D,K5E,NO,  NO, NO,  \
    KE1,NO, K1D,K1B,K06,K19,K05,K11,K10,K36,K37,K38,    NO, KE5,      K52,      K59,K5A,K5B,NO,  NO, NO,  \
    KE0,KE3,KE2,NO, NO,     K2C,    NO, NO, NO, KE6, NO,K65,KE4,  K50,K51,K4F,  K62,    K63,K58, NO, NO   \
 ...
 */
    ...
    LCTL, LGUI,LALT,          SPC,                     RALT,RGUI,APP, FN0,     LEFT,DOWN,RGHT,    P0,       PDOT,PENT
    ),

    [BASE] =
        KEYMAP_HHKB(
	       ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSLS, GRV, \
               TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   ALL_T(LBRC),RBRC,BSPC, \
               LCTL,A,   S,   D,   F,   G,   H,   J,   K,   L,   MEH_T(SCLN),LCAG_T(QUOT),FN12, \
    ...
    ESC,      F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12,      PSCR,SLCK,BRK,
    GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSPC,     INS, HOME,PGUP,    NLCK,PSLS,PAST,PMNS,
    TAB,FN8,FN9,FN10,   R,   T,   Y, FN7,   I,   O,   P,   LBRC,RBRC,BSLS,     DEL, END, PGDN,    P7,  P8,  P9,
    LCTL,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,     ENT,                         P4,  P5,  P6,  PPLS,
    LSFT,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,          RSFT,          UP,           P1,  P2,  P3,
    LCTL,LGUI,LALT,          SPC,                     RALT,RGUI,APP, RCTL,     LEFT,DOWN,RGHT,    P0,       PDOT,PENT
    ),
...
const action_t fn_actions[] PROGMEM = {
  ...
  [0]  = ACTION_LAYER_TAP_KEY(HHKB, KC_GUI),
  [1]  = ACTION_LAYER_TAP_KEY(HHKB, KC_CAPS),
  [2]  = ACTION_LAYER_TAP_KEY(LAYER, KC_BSLS),
  [3]  = ACTION_MODS_TAP_KEY(MOD_LSFT, KC_F19),
  [4]  = ACTION_MODS_TAP_KEY(MOD_LSFT | MOD_LCTL | MOD_LALT | MOD_LGUI, KC_LBRC),
  [5]  = ACTION_MODS_TAP_KEY(MOD_LCTL | MOD_LALT | MOD_LGUI, KC_QUOT),
  [6]  = ACTION_MODS_TAP_KEY(MOD_LCTL | MOD_LALT | MOD_LSFT, KC_SCLN),
  [7]  = ACTION_DEFAULT_LAYER_SET(BASE),
  [8]  = ACTION_DEFAULT_LAYER_SET(IOS),
  [9]  = ACTION_DEFAULT_LAYER_SET(PSEUDO_US),
  [10]  = ACTION_DEFAULT_LAYER_SET(MOUSE),
  [11] = ACTION_DEFAULT_LAYER_SET(TENKEY),
  [12] = ACTION_DEFAULT_LAYER_SET(DVORAK),
  [13] = ACTION_MODS_TAP_KEY(MOD_RCTL, KC_ENT),
  [20] = ACTION_MACRO(0),
};
